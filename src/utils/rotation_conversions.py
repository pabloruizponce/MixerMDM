...
def rotation_6d_to_matrix(d6: torch.Tensor) -> torch.Tensor:
    ...
    """
    d6_tmp = d6.clone()
    d6 = torch.cat((d6_tmp[..., [0,2,4]], d6_tmp[..., [1,3,5]]), dim=-1)
...
def matrix_to_rotation_6d(matrix: torch.Tensor) -> torch.Tensor:
    ...
    d6 = matrix[..., :2, :].clone().reshape(*matrix.size()[:-2], 6)
...
def rotation_6d_to_axis_angle(rotation_6d: torch.Tensor) -> torch.Tensor:
    """
    Converts 6D rotation representation to axis-angle representation.
    Args:
        rotation_6d: 6D rotation representation, of size (*, 6)
    """
