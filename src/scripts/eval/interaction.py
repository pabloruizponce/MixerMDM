...
if __name__ == '__main__':
    ...
    parser.add_argument('--v', type=int, required=True, help='Version of the model', default=1)
    ...
    if args.mode == "dual":
        ...
        print("Evaluating interacion model")
    ...
    device = torch.device('cuda:%d' % args.device if torch.cuda.is_available() else 'cpu')
    gt_loader, gt_dataset = get_dataset_motion_loader(data_cfg, batch_size, num_samples)
