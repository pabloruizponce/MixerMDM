...
from datasets import DataModuleIndividual
...
if __name__ == '__main__':
    ...
    wandb_logger = WandbLogger(project='EvaluatorIndividual', name=train_cfg.GENERAL.EXP_NAME)

    data_cfg = get_config(args.data).individual
    datamodule = DataModuleIndividual(data_cfg, train_cfg.TRAIN.BATCH_SIZE, train_cfg.TRAIN.NUM_WORKERS)
    model = InterCLIP(model_cfg)
